...
public class AdminController {
    ...
    public ModelAndView MemberSelectByUserId(String userId) {
        ...
        List<MemberDTO> list = memberService.selectByUserId(userId);
    ...
    public String MemberDeleteByUserId(@PathVariable String memberId) {
        ...
        int result = memberService.deleteMemberByUserId(memberId);
    ...
    public ModelAndView MessageSelectAll() {
        ...
        List<MessageDTO> list = messageService.messageSelectAll();
    ...
    public void SendMessage(HttpServletRequest request) {
        int result = messageService.insertMessage(new MessageDTO(0, "admin",request.getParameter("receiverId"), request.getParameter("title"), request.getParameter("context"), "sysdate", false, false));
    }
    ...
    public String deleteMessage(int messageNum) {
        ...
        messageService.deleteMessage(messageNum);
    ...
    public String InsertTeacher(MemberDTO memberDTO) {
