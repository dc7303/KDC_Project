...
<link rel="stylesheet" id="css-noticeBoardList" href="${pageContext.request.contextPath }/resources/assets/css/main.css" />
...
<table align="center" cellpadding="5" cellspacing="2" width="600" border="1" >
    ...
    <tr>
        <td width="1220" height="20" colspan="2" bgcolor="#00cc00">
            <p align="center"><font color="white" size="3"><b> 게시판등록 </b></font></p>
        </td>
    </tr>
    ...
    <tr>
        <td width="150" height="20">
            <p align="right"><b><span style="font-size:9pt;">게시판제목</span></b></p>
        </td>
        <td width="450" height="20"><b><span style="font-size:9pt;">
    <input type=text name="noticeBoardTitle" size="30"></span></b></td>
    </tr>
    ...
    <tr>
        ...
        <td width="450" height="20"><b><span style="font-size:9pt;">
    <textarea name="noticeBoardContents" cols="50" rows="10"></textarea></span></b></td>
    </tr>
