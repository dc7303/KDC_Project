...
INSERT INTO CLASSROOM_INFO VALUES ('AAAA', '전체공지사항', '9999-12-31', '9999-12-31', 'ocean', 'KK');

INSERT INTO NOTICE_BOARD VALUES (NOTICE_BOARD_SEQ.NEXTVAL, 'AAAA', '공지사항제목', 'lake', sysdate, '공지사항내용', '0', NULL, 'FALSE')
COMMIT
--댓글있는 게시판 테이블 생성
