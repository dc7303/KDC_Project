...
public class MemberController {
    ...
    public String memberPwdCheck(String memberPwd) {
        ...
        if(memberPwd.length() < 8 || memberPwd.length() > 14) message = "ÆĞ½º¿öµå ±æÀÌ´Â 8~14 ÀÚ¸®ÀÔ´Ï´Ù.";
        else if (!matcher1.find()) message = "ÆĞ½º¿öµå¿¡ ¼ıÀÚ°¡ Æ÷ÇÔµÇÁö ¾Ê¾Ò½À´Ï´Ù.";
        else if (!matcher2.find()) message = "ÆĞ½º¿öµå¿¡ ¼Ò¹®ÀÚ°¡ Æ÷ÇÔµÇÁö ¾Ê¾Ò½À´Ï´Ù.";
        else if (matcher3.find()) message = "ÆĞ½º¿öµå´Â ´ë¹®ÀÚ ¼Ò¹®ÀÚ¸¦ ±¸ºĞÇÕ´Ï´Ù.";
        else if (!matcher4.find()) message = "ÆĞ½º¿öµå¿¡ Æ¯¼ö¹®ÀÚ°¡ Æ÷ÇÔµÇÁö ¾Ê¾Ò½À´Ï´Ù.";
        else message = "»ç¿ë°¡´ÉÇÑ ºñ¹Ğ¹øÈ£ÀÔ´Ï´Ù.";
        */
